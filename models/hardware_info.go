...
func (m *HardwareInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateConnectedWirelessDevices(formats); err != nil {
		res = append(res, err)
	}
...
func (m *HardwareInfo) validateConnectedWirelessDevices(formats strfmt.Registry) error {
	if swag.IsZero(m.ConnectedWirelessDevices) { // not required
		return nil
	}
...
func (m *HardwareInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateConnectedWirelessDevices(ctx, formats); err != nil {
		res = append(res, err)
	}
